...
🏗️ AWS Services Used
Service	Purpose
Amazon EC2	Compute resources and application hosting
Amazon VPC	Network isolation and infrastructure networking
IAM	Roles, policies and access control
Amazon EBS	Persistent storage for EC2 instances
Amazon S3	Application/static workload hosting and storage
CloudWatch	Metrics, dashboards and monitoring
Auto Scaling	Automatic scaling based on workload requirements
